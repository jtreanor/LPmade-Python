...
IPageRankLinkPredictor::~IPageRankLinkPredictor() {
}

double IPageRankLinkPredictor::generateScore( vertex_t vertex, vertex_t neighbor ) {
	return this->scores.at( vertex );
}
